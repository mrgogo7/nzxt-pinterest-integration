...
const dict: Record<Lang, Record<string, string>> = {
  ...
  tr: {
    ...
    colorPickerDescription: "LCD ekran arka planı için düz bir renk seçin. Medya URL'i ayarlanmadığında bu renk gösterilecektir.",
    quickPresets: "Hızlı Ayarlar",
    previewTitle: "Medya Önizleme",
    overlayPreviewTitle: "Overlay Önizleme",
    settingsTitle: "Medya Ayarları",
    mediaOptionsTitle: "Medya Seçenekleri",
